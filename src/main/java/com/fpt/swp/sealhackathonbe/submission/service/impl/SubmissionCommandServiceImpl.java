...
public class SubmissionCommandServiceImpl implements SubmissionCommandService {
    ...
    // authentication.
    private static final UUID TEAM_STATUS_DISQUALIFIED = UUID.fromString("60000000-0000-0000-0000-000000000003");

    private static final UUID TEAM_STATUS_WITHDRAWN = UUID.fromString("60000000-0000-0000-0000-000000000004");

    private static final UUID TEAM_STATUS_ACTIVE = UUID.fromString("60000000-0000-0000-0000-000000000002");
