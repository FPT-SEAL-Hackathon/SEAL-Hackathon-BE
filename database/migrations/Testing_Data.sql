...
DECLARE @MentorUserTypeID UNIQUEIDENTIFIER = COALESCE((SELECT UserTypeID FROM UserType WHERE TypeName = N'Mentor'), '77777777-7777-7777-7777-777777777777');
...
DECLARE @ExpertUserTypeID UNIQUEIDENTIFIER = COALESCE((SELECT UserTypeID FROM UserType WHERE TypeName = N'Expert'), '33333333-3333-3333-3333-333333333333');
...
IF NOT EXISTS (SELECT 1 FROM UserType WHERE TypeName = N'Expert')
    INSERT INTO UserType (UserTypeID, TypeName) VALUES (@ExpertUserTypeID, N'Expert');
