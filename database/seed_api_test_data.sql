...
BEGIN TRY
    ...
    */
    ...
    -- "Pending Approval" (…0001) đã bỏ: duyệt nay ở cấp TEAM, không seed account status này nữa.
    ...
    IF NOT EXISTS (SELECT 1 FROM SubmissionStatus WHERE StatusID = '50000000-0000-0000-0000-000000000005')
        INSERT INTO SubmissionStatus (StatusID, StatusName) VALUES ('50000000-0000-0000-0000-000000000005', N'Scored');
    ...
    IF NOT EXISTS (SELECT 1 FROM TeamStatus WHERE StatusID = '60000000-0000-0000-0000-000000000004')
        INSERT INTO TeamStatus (StatusID, StatusName) VALUES ('60000000-0000-0000-0000-000000000004', N'Withdrawn');
    IF NOT EXISTS (SELECT 1 FROM TeamStatus WHERE StatusID = '60000000-0000-0000-0000-000000000005')
        INSERT INTO TeamStatus (StatusID, StatusName) VALUES ('60000000-0000-0000-0000-000000000005', N'Pending');
    IF NOT EXISTS (SELECT 1 FROM TeamStatus WHERE StatusID = '60000000-0000-0000-0000-000000000006')
        INSERT INTO TeamStatus (StatusID, StatusName) VALUES ('60000000-0000-0000-0000-000000000006', N'Rejected');
